...
('Compilation', 'Grease: The Original Soundtrack', 1978, 14.4, 'Soundtrack'),
...
('Compilation', 'Dirty Dancing', 1987, 17.9, 'Soundtrack'),
...
('Dire Straits', 'Brothers in Arms', 1985, 17.7, 'Blues Rock'),
